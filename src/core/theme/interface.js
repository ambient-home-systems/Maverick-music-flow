...
${liveDiagnosticsStyles}
  :host, .card {
    --maverick-dialog-layer:2147483203;
    --maverick-font-family:"Maverick Heebo",Heebo,Arial,sans-serif;
    --primary-font-family:var(--maverick-font-family);
    --paper-font-common-base_-_font-family:var(--maverick-font-family);
    --paper-font-body1_-_font-family:var(--maverick-font-family);
    font-family:var(--maverick-font-family);
    --maverick-surface:rgba(16,17,19,calc(var(--ma-popup-opacity,.9) * .8));
    --maverick-surface-border:rgba(255,255,255,.12);
    --maverick-surface-text:#f4f5f6;
    --maverick-surface-muted:#b8bdc5;
    --maverick-scrim:rgba(0,0,0,.16);
  }
  :host(.theme-light), .theme-light {
    --maverick-surface:rgba(250,251,252,calc(var(--ma-popup-opacity,.9) * .86));
    --maverick-surface-border:rgba(25,31,40,.12);
    --maverick-surface-text:#20242b;
    --maverick-surface-muted:#56606d;
    --maverick-scrim:rgba(245,247,250,.12);
  }
  ...
  .card :is(.ctx-menu,.lyrics-sheet,.history-drawer,.surprise-popup-card,.tablet-volume-popup,.smart-voice-sheet,.voice-assistant-dialog,.artist-info-dialog,.control-room-shell,.control-room-tray,.toast) {
    background:var(--maverick-surface)!important;
    border-color:var(--maverick-surface-border)!important;
    color:var(--maverick-surface-text)!important;
    --ma-text-1:var(--maverick-surface-text);
    --ma-text-2:var(--maverick-surface-muted);
    --ma-text-3:var(--maverick-surface-muted);
  ...
  .card :is(.modal-backdrop,.queue-action-backdrop,.control-room-backdrop) {
    background:var(--maverick-scrim)!important;
  }
  ...
  .card img[data-maverick-brand-logo] { object-fit:contain!important; height:auto!important; max-width:100%; aspect-ratio:auto; transform:none!important; }
  ...
  #mobileMenu .discovery-category-select > span { font-size:12px; font-weight:550; text-transform:none; color:var(--maverick-surface-muted); }
  #mobileMenu .discovery-category-select select { box-sizing:border-box; min-width:0; max-width:100%; width:100%; min-height:48px; border:1px solid var(--maverick-surface-border); border-radius:14px; padding:10px 14px; font:inherit; font-size:14px; font-weight:500; color:var(--maverick-surface-text); background:color-mix(in srgb,var(--maverick-surface-text) 5%,transparent); box-shadow:none; }
  #mobileMenu .discovery-category-select option { background:var(--ma-panel,#20242b); color:var(--maverick-surface-text); }
  #mobileMenu .discovery-catalog .discovery-player-focus { box-sizing:border-box; width:100%; max-width:none; min-height:68px; grid-template-columns:42px minmax(0,1fr) auto; grid-template-rows:auto auto; gap:2px 12px; border-radius:14px; padding:12px; border-color:var(--maverick-surface-border); box-shadow:none; background:color-mix(in srgb,var(--maverick-surface-text) 4%,transparent); font:inherit; transform:none; }
  ...
  #mobileMenu .discovery-player-kicker { grid-column:2; grid-row:1; font-size:11px; font-weight:500; color:var(--maverick-surface-muted); }
  ...
  .card :is(.action-hub,.queue-settings-form) { width:100%; max-width:860px; margin-inline:auto; box-sizing:border-box; color:var(--maverick-surface-text); }
  .card .action-hub { max-width:520px; padding:8px 4px; }
  .card .action-hub-section { margin:0; padding:20px 4px; border-bottom:1px solid var(--maverick-surface-border); }
  .card .action-hub-section:first-child { padding-top:0; }
  .card .action-hub-section:last-child { border-bottom:0; padding-bottom:0; }
  .card .action-hub-section h3 { display:flex; align-items:center; gap:10px; margin:0 0 14px; font-size:13px; line-height:1.5; font-weight:500; color:var(--maverick-surface-muted); }
  ...
  .card .action-hub .action-tile { display:flex; align-items:center; justify-content:center; min-width:0; min-height:60px; height:auto; padding:8px; border:0; border-radius:16px; background:transparent; box-shadow:none; color:var(--maverick-surface-text); transition:background .16s; }
  .card .action-hub .action-tile .menu-item-main { display:flex; align-items:center; gap:12px; width:100%; min-width:0; }
  .card .action-hub .action-tile .menu-item-ico { display:grid; place-items:center; flex:0 0 48px; width:48px; height:48px; min-width:48px; padding:0; border:1px solid var(--maverick-surface-border); border-radius:50%; background:color-mix(in srgb,var(--maverick-surface-text) 5%,transparent); color:inherit; box-shadow:inset 0 1px 0 rgb(255 255 255 / 4%); }
  ...
  .card .action-hub .menu-item-sub { display:block; margin-top:3px; font-size:12px; line-height:1.5; color:var(--maverick-surface-muted); white-space:normal; }
  ...
  .card .action-hub-note { margin:0 0 24px; color:var(--maverick-surface-muted); font-size:13px; line-height:1.7; }
  .card .queue-settings-form fieldset { border:0; padding:0; margin:0; min-width:0; }
  .card .queue-settings-fields { display:grid; gap:16px; padding:18px; border:1px solid var(--maverick-surface-border); border-radius:20px; background:color-mix(in srgb,var(--maverick-surface-text) 3%,transparent); }
  ...
  .card .queue-setting-field :is(select,input[type="number"]) { box-sizing:border-box; width:100%; min-width:0; min-height:46px; border:1px solid var(--maverick-surface-border); border-radius:13px; background:color-mix(in srgb,var(--maverick-surface-text) 5%,transparent); color:var(--maverick-surface-text); font:inherit; padding:10px 12px; }
  ...
  .card .queue-setting-field input[role="switch"] { appearance:none; position:relative; flex:0 0 44px; width:44px; height:26px; margin:0; border:1px solid var(--maverick-surface-border); border-radius:20px; background:color-mix(in srgb,var(--maverick-surface-text) 16%,transparent); cursor:pointer; }
  .card .queue-setting-field input[role="switch"]::after { content:""; position:absolute; top:3px; left:3px; width:18px; height:18px; background:var(--maverick-surface-text); border-radius:50%; transition:transform .15s; }
  ...
  .card .media-action-art { width:52px; height:52px; border-radius:12px; overflow:hidden; display:grid; place-items:center; background:color-mix(in srgb,var(--maverick-surface-text) 6%,transparent); }
  ...
  .card .media-action-secondary { margin-top:18px; padding-top:14px; border-top:1px solid var(--maverick-surface-border); }
  .card .media-action-secondary p { margin:0 0 10px; color:var(--maverick-surface-muted); font-size:12px; }
  ...
  .card .media-action-layout.icons-only .queue-action-item { min-height:48px; padding:10px; border-radius:50%; aspect-ratio:1; width:48px; justify-self:center; background:transparent; border-color:var(--maverick-surface-border); color:var(--maverick-surface-text); }
  .card .media-action-layout [data-media-popup="play"] { background:var(--maverick-surface-text)!important; color:var(--maverick-surface-bg,#141518)!important; border-color:transparent!important; }
  ...
  .card .media-action-layout .media-action-secondary .queue-action-item { color:var(--maverick-surface-muted); }
  .card .media-action-layout .media-action-heading .queue-action-item { width:36px; min-height:36px; padding:8px; border:0; border-radius:50%; background:color-mix(in srgb,var(--maverick-surface-text) 5%,transparent); color:var(--maverick-surface-muted); }
  .card .media-action-layout .queue-move-control { margin-bottom:16px; }
  .card .ctx-menu { padding:8px; border-radius:20px; }
  .card .ctx-menu .ctx-item { width:100%; min-height:44px; border:0; background:transparent; color:var(--maverick-surface-text); font:inherit; font-size:13px; font-weight:500; }
  .card .ctx-menu .ctx-item svg { width:22px; height:22px; flex:0 0 22px; }
  .card .player-volume-unavailable { color:var(--maverick-surface-muted); font-size:12px; line-height:1.6; padding:8px 12px; }
  @media(hover:hover) { .card .action-hub .action-tile:hover { background:color-mix(in srgb,var(--maverick-surface-text) 9%,transparent); border-color:color-mix(in srgb,var(--maverick-surface-text) 24%,transparent); } }
  ...
  .card .queue-drag-handle { touch-action:none; cursor:grab; min-width:36px; min-height:48px; padding:0; display:grid; place-items:center; color:var(--maverick-surface-muted); background:transparent; border:0; }
  .card .queue-dragging { opacity:.55; }
  .card .queue-drop-target { outline:2px solid var(--maverick-surface-text); outline-offset:-2px; border-radius:16px; }
  .card .queue-playback-options .chip-btn { display:inline-flex!important; align-items:center; justify-content:center; min-width:48px; min-height:48px; gap:8px; border:1px solid var(--maverick-surface-border); border-radius:16px; background:transparent; color:var(--maverick-surface-text); }
  ...
  .card .group-setup-intro p,.card .group-members-summary { margin:0 0 12px; color:var(--maverick-surface-muted); font-size:14px; line-height:1.6; }
  ...
  .card .group-player-card { background:color-mix(in srgb,var(--maverick-surface-text) 4%,transparent)!important; border:1px solid var(--maverick-surface-border)!important; border-radius:20px!important; box-shadow:none!important; }
  .card .group-player-card.checked { border-color:color-mix(in srgb,var(--maverick-surface-text) 45%,transparent)!important; }
  .card .group-player-row { min-height:84px; gap:12px; cursor:pointer; }
  .card .group-player-toggle svg { width:28px; height:28px; }
  .card .group-actions { position:sticky; bottom:0; display:flex; gap:12px; padding:12px 4px; background:var(--maverick-surface); backdrop-filter:blur(24px); border-top:1px solid var(--maverick-surface-border); }
  ...
  .card :is(.announcement-target,.announcement-input-wrap,.schedule-panel-card,.schedule-row,.scheduled-start-card,.night-time-card) { border:1px solid var(--maverick-surface-border)!important; border-radius:20px!important; background:color-mix(in srgb,var(--maverick-surface-text) 4%,transparent)!important; box-shadow:none!important; color:var(--maverick-surface-text)!important; }
  ...
  .card :is(.announcement-target-select,.scheduled-start-field select) { min-height:44px; font:inherit; color:var(--maverick-surface-text); background:transparent!important; }
  ...
  .card .sleep-timer-action-btn { min-height:64px; border-radius:18px!important; font-size:23px; font-weight:500; border:1px solid var(--maverick-surface-border)!important; background:color-mix(in srgb,var(--maverick-surface-text) 5%,transparent)!important; color:var(--maverick-surface-text); box-shadow:none!important; }
  ...
  .card .lyrics-head { display:flex; flex-wrap:wrap; gap:16px; padding:20px!important; border-bottom:1px solid var(--maverick-surface-border); background:transparent!important; }
  ...
  .card .lyrics-head-actions button { min-width:44px; min-height:44px; border-radius:14px!important; color:var(--maverick-surface-text); box-shadow:none!important; }
  ...
  .card .lyrics-state { display:grid; place-content:center; min-height:180px; font-size:16px; color:var(--maverick-surface-muted); text-align:center; }
  /* One artwork treatment for every surface, with a stable contrast veil. */
  .card { --maverick-art-veil:rgba(12,14,18,.40); }
  .card.theme-light { --maverick-art-veil:rgba(250,251,253,.60); }
  .card #mobileMenu.menu-backdrop[class] .menu-sheet[class],
  ...
  .card :is(.menu-sheet,.queue-action-sheet,.lyrics-sheet,.history-drawer,.modal,.ctx-menu,.surprise-popup-card,.tablet-volume-popup,.smart-voice-sheet,.voice-assistant-dialog,.artist-info-dialog,.control-room-shell,.control-room-tray,.toast)::before {
    ...
    background:linear-gradient(var(--maverick-art-veil),var(--maverick-art-veil)),var(--lyrics-dynamic-art,var(--menu-dynamic-art,var(--dynamic-art-url,none))) center/cover!important;
  ...
  .card .lyrics-line { font-weight:500; opacity:.72; transform:none; color:var(--maverick-surface-text); overflow-wrap:anywhere; }
  .card .lyrics-line.active [data-lyrics-word-time] { opacity:.5; transition:opacity .12s ease,color .12s ease; }
  .card .lyrics-line.active [data-lyrics-word-time].sung { opacity:1; color:var(--ma-accent,var(--maverick-surface-text)); }
  .card .listening-stats { padding:20px; color:var(--maverick-surface-text); }
  ...
  .card .queue-move-pending::after { content:"";width:18px;height:18px;border:2px solid currentColor;border-top-color:transparent;border-radius:50%;animation:maverick-pending-spin .8s linear infinite; }
  @keyframes maverick-pending-spin { to { transform:rotate(360deg); } }
  .card .screen-all-actions { animation:maverick-screen-enter .18s ease-out; }
  @keyframes maverick-screen-enter { from {opacity:0;transform:translateY(8px);} to {opacity:1;transform:none;} }
  @media (prefers-reduced-motion:reduce) { .card .screen-all-actions,.card .queue-move-pending::after {animation:none;} }
  .card .lyrics-line.active { font-weight:700; opacity:1; transform:none; color:var(--maverick-surface-text); text-shadow:none; }
  ...
  .card .playlist-destination { width:100%; min-height:48px; padding:10px; border-radius:14px; background:var(--maverick-surface); color:var(--maverick-surface-text); border:1px solid var(--maverick-surface-border); font:inherit; }
  ...
  .card #immersiveCloseBtn { background:transparent!important; border-color:transparent!important; box-shadow:none!important; backdrop-filter:none!important; -webkit-backdrop-filter:none!important; color:var(--maverick-surface-text)!important; }
  ...
  .card .footer-nav > .mobile-edge-corner-btn { position:static!important; inset:auto!important; transform:none!important; opacity:1!important; flex:0 0 44px; align-self:center; padding:7px!important; color:var(--maverick-surface-text)!important; }
  ...
  .card.player-design-immersive .immersive-layout .immersive-dock > .mobile-edge-corner-btn { position:static!important; inset:auto!important; transform:none!important; opacity:1!important; width:44px!important; height:44px!important; min-height:44px!important; padding:7px!important; color:var(--maverick-surface-text)!important; background:transparent!important; backdrop-filter:none!important; -webkit-backdrop-filter:none!important; }
  .card .screen-all-actions { position:absolute; inset:0 0 76px; z-index:29; padding:24px; overflow:auto; scrollbar-width:none; background:var(--maverick-surface); backdrop-filter:blur(40px); -webkit-backdrop-filter:blur(40px); color:var(--maverick-surface-text); }
  .card .screen-all-actions > div { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:12px; }
  .card .screen-all-actions button { display:flex; flex-direction:column; align-items:center; justify-content:center; gap:12px; min-height:96px; padding:16px; border-radius:18px; border:1px solid var(--maverick-surface-border); background:transparent; color:inherit; font:inherit; }
  ...
  .card .media-library-back { display:flex; align-items:center; gap:10px; min-height:44px; margin:12px 0 20px; padding:8px 0; border:0; background:transparent; color:var(--maverick-surface-text); font:inherit; }
  ...
  @media(min-width:0px) {
    ...
    .card .has-screen-dock > .screen-dock { position:absolute!important; z-index:30!important; inset:auto 0 0!important; transform:none!important; margin:0!important; width:100%!important; max-width:none!important; height:auto; min-height:66px; display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:8px; padding:8px 14px max(8px,env(safe-area-inset-bottom,0px)); box-sizing:border-box; border-radius:20px 20px 0 0; background:var(--maverick-surface); backdrop-filter:blur(28px); -webkit-backdrop-filter:blur(28px); }
    .card .screen-dock > button { display:grid; place-items:center; width:100%; min-height:44px; border:0; color:var(--maverick-surface-text); background:transparent; }
    ...
    .card .screen-dock::before { content:""; position:absolute; inset:0; border-radius:inherit; background:var(--maverick-surface); backdrop-filter:blur(28px); -webkit-backdrop-filter:blur(28px); pointer-events:none; }
    ...
    .card .history-toggle-fab.tablet-history-fab { background:transparent!important; color:var(--maverick-surface-text)!important; border:0!important; backdrop-filter:none!important; -webkit-backdrop-filter:none!important; box-shadow:none!important; }
  ...
  .card .history-drawer.has-screen-dock > .screen-dock {
    ...
    border-top:1px solid var(--maverick-surface-border);
  }
  ...
  .card :is(#mobileQueueActionSheet,.menu-sheet,.lyrics-sheet,.history-drawer).has-screen-dock > .screen-all-actions {
    ...
    background:color-mix(in srgb,var(--maverick-surface) 65%,transparent);
  }
  ...
  .card .queue-action-sheet[data-dock-page="media_actions"] { background:color-mix(in srgb,var(--maverick-surface) 48%,transparent)!important; }
  ...
  .card #mobileMenu :is(.library-toolbar-search,.library-tab-search-row) {
    ...
    background:var(--maverick-surface)!important; border:1px solid var(--maverick-surface-border)!important;
  }
  .card #mobileMenu [data-library-tab-search-input] { min-width:0!important; min-height:44px!important; font-size:16px!important; color:var(--maverick-surface-text)!important; }
  ...
  .card #mobileMenu :is(.library-toolbar-sort-select,#discoveryCategorySelect,#discoveryProviderSelect) {
    ...
    border-radius:16px!important; color:var(--maverick-surface-text)!important;
    background-color:var(--maverick-surface)!important; border:1px solid var(--maverick-surface-border)!important;
  }
  .card #mobileMenu :is([data-library-tab-search-input],select):focus-visible { outline:2px solid var(--maverick-surface-text); outline-offset:2px; }
  ...
  .card .player-choice-counts bdi { color:var(--maverick-surface-text); font-weight:600; font-variant-numeric:tabular-nums; }
  ...
  .card .control-room-tray > .control-room-panel-close { position:absolute; top:8px; inset-inline-end:10px; z-index:3; width:40px; height:40px; padding:9px; display:grid; place-items:center; border:1px solid var(--maverick-surface-border); border-radius:50%; background:var(--maverick-surface); color:var(--maverick-surface-text); cursor:pointer; }
  ...
  @media(max-width:600px) {
    ...
    .card .player-choice-card { border-radius:18px; background:color-mix(in srgb,var(--maverick-surface) 75%,transparent); }
    .card .player-choice-card.selected { border-color:color-mix(in srgb,var(--maverick-surface-text) 60%,transparent); background:color-mix(in srgb,var(--maverick-surface-text) 12%,var(--maverick-surface)); }
    ...
    .card .player-choice-state { flex-wrap:wrap; color:var(--maverick-surface-text); }
  ...
  .card .fan-catalogue header { display:flex; align-items:center; gap:12px; position:sticky; top:0; z-index:2; background:var(--maverick-surface); backdrop-filter:blur(32px); }
  ...
  .card .smart-hub-grid button { display:flex; flex-direction:column; align-items:center; justify-content:center; gap:14px; min-height:120px; background:var(--maverick-surface); border:1px solid var(--maverick-surface-border); border-radius:22px; color:inherit; font:inherit; }
  ...
  .card .volume-wheel-popover { position:absolute; z-index:121; bottom:max(76px,env(safe-area-inset-bottom)); left:50%; transform:translateX(-50%); width:min(320px,90%); padding:18px; border-radius:160px 160px 28px 28px; border:1px solid var(--maverick-surface-border); background:var(--maverick-surface); backdrop-filter:blur(40px); color:var(--maverick-surface-text); display:flex; align-items:center; flex-direction:column; gap:10px; }
  ...
  .card .volume-wheel-dial output { display:grid; place-items:center; width:140px; height:140px; border-radius:50%; background:var(--maverick-surface); font-size:28px; }
  ...
  .card .smart-settings :is(input:not([type=checkbox]),select,button) { min-height:44px; border-radius:12px; border:1px solid var(--maverick-surface-border); padding:10px; background:var(--maverick-surface); color:inherit; font:inherit; }

  .card .menu-sheet[data-dock-page="group_volume"] { inset:auto!important; bottom:0!important; width:min(560px,100%)!important; max-height:85%!important; margin-inline:auto!important; border-radius:40px 40px 0 0!important; background:var(--maverick-surface)!important; backdrop-filter:blur(40px)!important; }
  ...
  .card :is(.immersive-fan,.volume-wheel-popover) {
    ...
    color:var(--maverick-surface-text);
  }
  ...
  .card[data-fan-theme="dark"] :is(.immersive-fan,.volume-wheel-popover) { --fan-glass-base:rgba(16,20,28,.46); --fan-glass-tint:transparent; color:#f4f5f6; --maverick-surface-muted:#d4d9e0; }
  .card[data-fan-theme="light"] :is(.immersive-fan,.volume-wheel-popover) { --fan-glass-base:rgba(250,252,255,.54); --fan-glass-tint:transparent; --fan-glass-edge:rgba(255,255,255,.7); color:#20242b; --maverick-surface-muted:#414b59; }
  ...
  .card :is(.smart-hub,.smart-settings,.listening-lighting,.recommendation-home) { box-sizing:border-box; width:100%; max-width:880px; margin-inline:auto; padding:clamp(16px,3vw,28px); color:var(--maverick-surface-text); text-align:start; }
  ...
  .card .smart-hub-grid button { background:color-mix(in srgb,var(--maverick-surface-text) 5%,transparent); border-radius:20px; min-height:100px; text-align:center; transition:background .18s; padding:12px 8px; }
  ...
  .card .smart-settings > label:has(input[type="checkbox"]) { flex:0 1 auto; flex-direction:row; align-items:center; padding:10px 14px; border:1px solid var(--maverick-surface-border); border-radius:14px; }
  .card .smart-settings :is(input,select,button) { box-sizing:border-box; font:inherit; color:inherit; border:1px solid var(--maverick-surface-border); border-radius:14px; background:color-mix(in srgb,var(--maverick-surface-text) 5%,transparent); padding:12px; min-height:46px; max-width:100%; }
  ...
  .card .volume-wheel-popover { padding-top:48px; box-sizing:border-box; z-index:var(--maverick-dialog-layer); }
  .card > .fan-catalogue { z-index:var(--maverick-dialog-layer); }
  .card .group-operation-feedback,
  .card #toastWrap { z-index:calc(var(--maverick-dialog-layer) + 1); }
  ...
  .card .lyrics-timeline.karaoke-active .lyrics-line.active { opacity:1; color:var(--ma-accent,var(--maverick-surface-text)); }
  ...
  .card [data-dock-page="group_volume"] .group-player-card { border:1px solid var(--maverick-surface-border); border-radius:18px; background:transparent; padding:12px; }
  ...
  .card.player-design-immersive {
    --flow-control-bg:color-mix(in srgb,var(--maverick-surface-text) 5%,transparent);
  ...
  .card.player-design-immersive .recommendation-shelf :is(button > svg,.recommendation-art > svg) { box-sizing:border-box; padding:28%; background:var(--flow-control-bg); border:1px solid var(--maverick-surface-border); color:var(--maverick-surface-muted); }
  ...
  .card.player-design-immersive :is(.schedule-tabs,.history-drawer-tabs,.settings-pills) { display:flex; flex-wrap:wrap; gap:6px; padding:5px; border:1px solid var(--maverick-surface-border); border-radius:18px; background:transparent; box-shadow:none; }
  .card.player-design-immersive :is(.settings-pill,.history-tab,.sleep-timer-action-btn,.history-play-all-btn,.action-btn,.control-room-tray-btn,.chip-btn) {
    box-sizing:border-box; min-height:44px; padding:10px 16px; border:1px solid var(--maverick-surface-border)!important;
    border-radius:var(--flow-control-radius)!important; background:var(--flow-control-bg)!important;
    color:var(--maverick-surface-text)!important; box-shadow:none!important; text-shadow:none!important;
    font-family:var(--maverick-font-family)!important; font-size:14px!important; line-height:1.4; font-weight:500!important;
  }
  ...
  .card.player-design-immersive #mobileMenu :is(.queue-page-count,.queue-page-head-actions button,.queue-row.active .queue-title) { color:var(--maverick-surface-text)!important; text-shadow:none!important; }
  ...
  .card.player-design-immersive :is(.settings-pill,.history-tab)[aria-selected="true"] { background:var(--flow-control-selected)!important; border-color:color-mix(in srgb,var(--ma-accent) 65%,transparent)!important; color:var(--maverick-surface-text)!important; }
  ...
  .card.player-design-immersive :is(.schedule-panel-card,.settings-group,.announcement-card) { border:1px solid var(--maverick-surface-border); border-radius:20px; background:transparent; padding:18px; box-shadow:none; }
  ...
  .card.player-design-immersive :is(.menu-body,.history-drawer,.media-action-layout,.control-room-tray) { font-family:var(--maverick-font-family); text-shadow:none!important; }
  ...
  .card.player-design-immersive .media-action-layout [data-media-popup="play"] { background:var(--flow-control-selected)!important; color:var(--maverick-surface-text)!important; border:1px solid color-mix(in srgb,var(--ma-accent) 65%,transparent)!important; }
  .card.player-design-immersive .media-action-layout.with-labels [data-media-popup="play"] { grid-column:auto; }
  .card.player-design-immersive :is(.menu-body,.control-room-tray) :is(select,input:not([type=range]):not([type=checkbox]):not([type=radio]),textarea) { box-sizing:border-box; max-width:100%; min-width:0; min-height:44px; border:1px solid var(--maverick-surface-border); border-radius:var(--flow-control-radius); background:var(--flow-control-bg); color:var(--maverick-surface-text); font:inherit; padding:10px 12px; }
  ...
  .card.player-design-immersive #mobileMenu .media-detail-kicker { font-weight:500; letter-spacing:0; text-transform:none; color:var(--maverick-surface-muted); }
  .card.player-design-immersive #mobileMenu .media-detail-sub { margin-block:8px; color:var(--maverick-surface-muted); line-height:1.5; }
  ...
  .card.player-design-immersive #mobileMenu .media-detail-track-row { min-height:64px; border:0; border-bottom:1px solid var(--maverick-surface-border); border-radius:0; background:transparent; box-shadow:none; padding:8px 4px; }
  .card.player-design-immersive #mobileMenu .media-detail-track-title { font-weight:500; color:var(--maverick-surface-text); }
  .card.player-design-immersive #mobileMenu :is(.media-detail-track-sub,.media-detail-track-duration,.media-detail-track-index) { font-weight:400; color:var(--maverick-surface-muted); }
  ...
  .card.player-design-immersive #mobileMenu .artist-year-title { font-size:15px; font-weight:500; color:var(--maverick-surface-muted); padding-block:12px; }
  ...
  .card.player-design-immersive .fan-catalogue header { width:100%; max-width:960px; margin:0 auto 20px; padding:10px 0; box-sizing:border-box; gap:12px; background:transparent; backdrop-filter:none; border-bottom:1px solid var(--maverick-surface-border); }
  .card.player-design-immersive .fan-catalogue header button { flex-direction:row; min-height:44px; font-family:var(--maverick-font-family); font-size:13px; font-weight:400; border:0; border-radius:14px; background:var(--flow-control-bg); }
  ...
  .card.player-design-immersive .fan-catalogue-list [data-catalogue-action] { font:500 14px/1.45 var(--maverick-font-family); }
  ...
  .card.player-design-immersive .fan-catalogue-category { grid-column:1/-1; margin:18px 0 4px; font:500 15px/1.4 var(--maverick-font-family); color:var(--maverick-surface-muted); text-align:start; }
  ...
  .card.player-design-immersive .player-mini-volume::-webkit-slider-runnable-track { height:10px; border-radius:8px; background:linear-gradient(to right,var(--ma-accent) var(--vol-pct,50%),color-mix(in srgb,var(--maverick-surface-text) 20%,transparent) var(--vol-pct,50%)); }
  .card.player-design-immersive .player-mini-volume::-webkit-slider-thumb { width:24px!important; height:24px!important; margin-top:-7px; border:2px solid var(--maverick-surface-text); box-shadow:0 2px 8px #0003; }
  .card.player-design-immersive .player-mini-volume::-moz-range-track { height:10px; border-radius:8px; background:linear-gradient(to right,var(--ma-accent) var(--vol-pct,50%),color-mix(in srgb,var(--maverick-surface-text) 20%,transparent) var(--vol-pct,50%)); }
  .card.player-design-immersive .player-mini-volume::-moz-range-thumb { width:22px!important; height:22px!important; border:2px solid var(--maverick-surface-text); }
  .card .player-volume-percent { min-width:44px; min-height:44px; padding:0 2px; border:0; background:transparent; color:inherit; font:500 14px var(--maverick-font-family); font-variant-numeric:tabular-nums; cursor:pointer; text-align:center; direction:ltr; }
  ...
  .volume-wheel-title { max-width:100%; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; font:500 15px var(--maverick-font-family); }
  ...
  .card.player-design-immersive #mobileMenu .media-detail-hero-actions .media-detail-play-btn[data-media-detail-action="play"] { width:52px; height:52px; min-width:52px; display:inline-flex; align-items:center; justify-content:center; color:var(--maverick-surface-text); }
  ...
  .fan-preference-scope select { max-width:100%; padding:10px; border:1px solid var(--maverick-surface-border); border-radius:14px; background:var(--maverick-surface); color:inherit; font:inherit; }
  ...
  .group-quick-connect { display:flex; align-items:center; justify-content:center; gap:8px; min-height:44px; margin:4px 12px 10px; padding:8px 18px; border:1px solid var(--maverick-surface-border); border-radius:99px; color:var(--maverick-surface-text); background:var(--maverick-surface); font:500 14px var(--maverick-font-family); }
  .group-quick-connect svg { width:22px; height:22px; }
  .player-choice-card { transition:outline-color .18s, box-shadow .18s; }
  .player-group-preview { position:absolute; z-index:30; pointer-events:none; display:flex; align-items:center; gap:10px; max-width:220px; padding:12px 18px; border:1px solid var(--maverick-surface-border); border-radius:24px; background:var(--maverick-surface); backdrop-filter:blur(24px); -webkit-backdrop-filter:blur(24px); box-shadow:0 12px 36px #0003; transform:translate(-50%,-50%) scale(1.04); font:500 14px/1.3 var(--maverick-font-family); }
  ...
  .group-pair-names { font:400 13px var(--maverick-font-family); color:var(--maverick-surface-muted); text-align:center; overflow-wrap:anywhere; }
  .player-group-preview > span:last-child { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
  .group-connecting { outline:2px solid var(--ma-accent); animation:maverick-group-breathe 1.4s ease-in-out infinite; }
  .player-group-status { position:absolute; inset:0; display:grid; place-items:center; border-radius:inherit; background:var(--maverick-surface); backdrop-filter:blur(18px); font:500 14px var(--maverick-font-family); }
  .group-connected { animation:maverick-group-confirm .65s ease-out; }
  @keyframes maverick-group-breathe { 50% { box-shadow:0 0 24px color-mix(in srgb,var(--ma-accent) 25%,transparent); } }
  @keyframes maverick-group-confirm { 0% { transform:scale(.98); } 55% { transform:scale(1.015); } 100% { transform:scale(1); } }
  @media(prefers-reduced-motion:reduce) { .group-connecting,.group-connected { animation:none; } }
  .group-operation-feedback { position:absolute; z-index:120; inset-inline:0; bottom:calc(90px + env(safe-area-inset-bottom,0px)); margin-inline:auto; width:max-content; max-width:85%; display:flex; align-items:center; gap:14px; padding:14px 24px; border:1px solid var(--maverick-surface-border); border-radius:26px; background:var(--maverick-surface); color:var(--maverick-surface-text); backdrop-filter:blur(26px); -webkit-backdrop-filter:blur(26px); box-shadow:0 12px 40px #0002; font:500 14px/1.5 var(--maverick-font-family); animation:maverick-group-arrive .2s ease-out; pointer-events:none; }
  ...
  .has-player-art .group-operation-symbols i { display:grid; place-items:center; width:64px; height:64px; flex:none; overflow:hidden; opacity:1; border:2px solid var(--maverick-surface-border); border-radius:22px; background:var(--maverick-surface); box-shadow:0 8px 28px #0003; }
  ...
  .has-player-art.is-connect:not(.is-confirmed) .group-operation-symbols i:first-child { animation:maverick-pair-left 1.4s ease-in-out infinite; }
  .has-player-art.is-connect:not(.is-confirmed) .group-operation-symbols i:last-child { animation:maverick-pair-right 1.4s ease-in-out infinite; }
  ...
  @keyframes maverick-pair-left { 50% { transform:translateX(8px) rotate(-3deg); } }
  @keyframes maverick-pair-right { 50% { transform:translateX(-8px) rotate(3deg); } }
  ...
  @keyframes maverick-group-arrive { from { opacity:0; translate:0 6px; } to { opacity:1; translate:0 0; } }
  ...
  .card.player-design-immersive.performance-lite :is(.player-group-preview,.group-operation-feedback,.player-group-status,.fan-catalogue,.smart-settings) { background:var(--maverick-surface-solid,var(--card-background-color,#202226)); }
`;
