...
.card.player-design-immersive .immersive-metadata #npSub { font-size:14px!important; line-height:1.4!important; margin-top:6px; color:var(--maverick-surface-muted); }
...
.card.player-design-immersive #mobileBg { inset:-8%!important; width:116%!important; height:116%!important; background-image:none!important; --maverick-bg-layer-opacity:1; background-size:cover!important; background-position:center!important; filter:blur(38px) saturate(1.55)!important; opacity:.95!important; }
...
.player-choice-card { display:flex; align-items:center; gap:4px; min-width:0; border:1px solid var(--maverick-surface-border); border-radius:22px; background:color-mix(in srgb,var(--maverick-surface-text) 3%,transparent); color:var(--maverick-surface-text); }
.player-choice-card.selected { background:color-mix(in srgb,var(--maverick-surface-text) 9%,transparent); border-color:color-mix(in srgb,var(--maverick-surface-text) 35%,transparent); }
...
.player-choice-state { display:flex; align-items:center; gap:6px; font-size:11px; color:var(--maverick-surface-muted); }
...
.player-choice-track { font-size:12px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; color:var(--maverick-surface-muted); }
...
.player-choice-summary { display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px; max-width:760px; margin:8px auto 20px; font-size:13px; color:var(--maverick-surface-muted); }
.player-choice-summary .player-this-device-cta { min-height:58px; padding:8px 12px; border-radius:19px; border:1px solid color-mix(in srgb,var(--maverick-accent) 34%,var(--maverick-surface-border)); background:linear-gradient(135deg,color-mix(in srgb,var(--maverick-accent) 18%,transparent),color-mix(in srgb,var(--maverick-surface-text) 7%,transparent)); color:var(--maverick-surface-text); font:inherit; cursor:pointer; display:grid; grid-template-columns:40px minmax(0,1fr) 18px; align-items:center; gap:10px; text-align:start; box-shadow:0 12px 32px color-mix(in srgb,var(--maverick-accent) 12%,transparent),inset 0 1px 0 color-mix(in srgb,#fff 18%,transparent); backdrop-filter:blur(18px) saturate(135%); -webkit-backdrop-filter:blur(18px) saturate(135%); }
.player-this-device-icon { inline-size:40px; block-size:40px; border-radius:50%; display:grid; place-items:center; background:color-mix(in srgb,var(--maverick-accent) 24%,transparent); color:var(--maverick-surface-text); }
...
.player-this-device-copy small { color:var(--maverick-surface-muted); font-size:11px; line-height:1.25; white-space:normal; }
.player-this-device-arrow { color:var(--maverick-surface-muted); font-size:24px; line-height:1; }
.player-this-device-cta:hover,.player-this-device-cta:focus-visible { border-color:color-mix(in srgb,var(--maverick-accent) 62%,var(--maverick-surface-border)); transform:translateY(-1px); }
...
.card.player-design-immersive #mobileMenu .players-action-chip { background:color-mix(in srgb,var(--maverick-surface-text) 5%,transparent)!important; border-color:var(--maverick-surface-border)!important; box-shadow:none!important; border-radius:18px!important; }
...
.card.player-design-immersive #btnPlay { width:76px!important; height:76px!important; min-width:76px!important; border-radius:50%!important; background:var(--maverick-surface-text,#f4f2ed)!important; color:var(--maverick-surface-solid,#17181b)!important; box-shadow:0 6px 22px #0002!important; }
...
.card.player-design-immersive .mobile-volume-inline { display:flex!important; align-items:center; gap:10px!important; width:100%!important; box-sizing:border-box; min-height:60px!important; padding:6px 10px!important; border:1px solid var(--maverick-surface-border); border-radius:24px; background:color-mix(in srgb,var(--maverick-surface-text) 4%,transparent); }
...
.card.player-design-immersive #volSlider::-webkit-slider-thumb { width:24px!important; height:24px!important; margin-top:-7px!important; border:2px solid var(--maverick-surface-text)!important; border-radius:50%; box-shadow:0 2px 8px #0003!important; }
.card.player-design-immersive #volSlider::-moz-range-track { height:10px!important; border-radius:8px; }
.card.player-design-immersive #volSlider::-moz-range-thumb { width:22px!important; height:22px!important; border:2px solid var(--maverick-surface-text)!important; border-radius:50%; }
...
.card.player-design-immersive .progress-time { width:auto!important; font-size:12px!important; font-variant-numeric:tabular-nums; color:var(--maverick-surface-muted); }
...
.immersive-waveform .waveform-base { stroke:color-mix(in srgb,var(--maverick-surface-text) 23%,transparent); }
.immersive-waveform .waveform-played { stroke:rgb(var(--dynamic-glow-rgb,220 220 228)); }
.immersive-seek-preview { position:absolute; bottom:30px; transform:translateX(-50%); padding:5px 9px; border-radius:10px; background:var(--maverick-surface); color:var(--maverick-surface-text); backdrop-filter:blur(24px); font:12px var(--maverick-font-family); pointer-events:none; }
...
.card.player-design-immersive .progress-line.immersive-live #immersiveLiveStatus { grid-column:1 / -1; grid-row:1 / 3; align-self:center; text-align:center; color:var(--maverick-surface-text); }
...
#immersiveActionsToggle > svg { fill:none; padding:12px; box-sizing:content-box; border:1px solid var(--maverick-surface-border); border-radius:50%; background:var(--maverick-surface); }
#immersiveActionsToggle[aria-expanded=true] > svg { background:color-mix(in srgb,currentColor 15%,transparent); }
.immersive-fan { position:absolute; bottom:calc(100% + 8px); left:50%; width:min(440px,100%); height:220px; box-sizing:border-box; transform:translateX(-50%); display:block; padding:0 12px 6px; border:1px solid var(--maverick-surface-border); border-radius:50% 50% 18px 18px / 94% 94% 18px 18px; background:rgba(20,22,26,.84); backdrop-filter:blur(48px) saturate(.85); -webkit-backdrop-filter:blur(48px) saturate(.85); box-shadow:0 16px 48px #0004,inset 0 1px 0 #ffffff12; color:var(--maverick-surface-text); touch-action:pan-y; }
...
.immersive-fan-navigation { position:absolute; bottom:4px; inset-inline:22px; display:flex; align-items:center; justify-content:space-between; gap:6px; margin-top:0; border-top:1px solid var(--maverick-surface-border); }
.immersive-fan .immersive-fan-navigation button { min-height:44px; min-width:44px; padding:4px 8px; font-size:12px; }
.immersive-page-status { font-size:11px; color:var(--maverick-surface-muted); direction:ltr; }
.immersive-fan button:disabled { opacity:.35; cursor:default; }
.immersive-fan[hidden] { display:none!important; }
@media (prefers-reduced-motion:no-preference) {
  .immersive-fan:not([hidden]) { transform-origin:50% 100%; animation:maverick-fan-reveal .22s cubic-bezier(.2,.8,.2,1); }
  @keyframes maverick-fan-reveal {
...
.card.player-design-immersive .immersive-layout .immersive-dock { border-top:1px solid var(--maverick-surface-border); background:color-mix(in srgb,var(--maverick-surface-solid) 30%,transparent); border-radius:0 0 22px 22px; backdrop-filter:none; -webkit-backdrop-filter:none; }
...
.card.compact-mode.compact-mode .compact-content > .immersive-dock { grid-area:dock; display:flex!important; align-items:center; height:48px!important; padding:0!important; max-width:none; border-top:1px solid var(--maverick-surface-border); }
