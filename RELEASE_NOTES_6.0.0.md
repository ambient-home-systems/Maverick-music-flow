...
[Beginner installation, upgrade and rollback guide](https://github.com/r11a/homeii-music-flow/blob/v6.0.0/docs/INSTALL_STEP_BY_STEP.md) · [Required Engine](https://github.com/ambient-home-systems/maverick-music-flow-engine)
